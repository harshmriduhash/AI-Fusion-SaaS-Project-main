...
import Footer from '@/components/rp/Footer';
import Header from '@/components/rp/Header';
import SquigglyLines from '@/components/rp/SquigglyLines';
import { Testimonials } from '@/components/rp/Testimonials';
